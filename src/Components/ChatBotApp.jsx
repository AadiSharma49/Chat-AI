    ...
    if(!activeChat){
      ...
      const response = await fetch("https://api.openai.com/v1/chat/completions",{
          ...
          headers: {
           ...
           Authorization:`Bearer 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`,},
          body:JSON.stringify({
           model:"gpt-3.5-turbo",
    ...
    <div className="chat-app">
      <div className={`chat-list ${showChatList?'show':""}`}>
        ...
        {chats.map((chat)=>(
          ...
          <i className="bx bx-x-circle" onClick={(e)=>{e.stopPropagation()
      ...
      <div className="chat-window">
        ...
        <div className="chat">
          {
             ...
             <div key={index} className={msg.type==="prompt"?"prompt":"response"}>
              {msg.text}<span>{msg.timestamp}</span></div>
          ))}
        ...
        <form className="msg-form" onSubmit={(e)=>e.preventDefault()}>
          ...
          {showEmojiPicker && (<div className="picker">
            <Picker data={data} onEmojiSelect={handleEmojiSelect}/></div>
            )}
          <input 
          type="text" 
          className="msg-input" 
